//因為資料元件化   props引用data的tempProduct進來  
// $emit送出時觸發也要將tempProduct丟出去作為參數
export default {
  ...
  mounted() {
    productModalSample = new bootstrap.Modal(document.querySelector('#productModal'))
  },
  ...
  template: ` <div id="productModal" ref="productModal" class="modal fade" tabindex="-1" aria-labelledby="productModalLabel"
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div v-if="Array.isArray(tempProduct.imagesUrl)">
          ...
          <div v-if="!tempProduct.imagesUrl.length || tempProduct.imagesUrl[tempProduct.imagesUrl.length - 1] || 5 > key ">
